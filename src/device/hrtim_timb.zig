...
pub const HRTIM_TIMB = struct {
    // Timerx Control Register
    TIMBCR: packed struct(u32) {
...
pub const HRTIM_TIMB_BASE_ADDRESS: usize = 0x40017500;
pub const HRTIM_TIMB_REGISTERS: *volatile HRTIM_TIMB = @ptrFromInt(HRTIM_TIMB_BASE_ADDRESS);
