...
pub const HRTIM_TIMC = struct {
    // Timerx Control Register
    TIMCCR: packed struct(u32) {
...
pub const HRTIM_TIMC_BASE_ADDRESS: usize = 0x40017580;
pub const HRTIM_TIMC_REGISTERS: *volatile HRTIM_TIMC = @ptrFromInt(HRTIM_TIMC_BASE_ADDRESS);
