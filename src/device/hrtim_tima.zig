...
pub const HRTIM_TIMA = struct {
    // Timerx Control Register
    TIMACR: packed struct(u32) {
...
pub const HRTIM_TIMA_BASE_ADDRESS: usize = 0x40017480;
pub const HRTIM_TIMA_REGISTERS: *volatile HRTIM_TIMA = @ptrFromInt(HRTIM_TIMA_BASE_ADDRESS);
