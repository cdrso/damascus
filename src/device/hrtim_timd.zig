...
pub const HRTIM_TIMD = struct {
    // Timerx Control Register
    TIMDCR: packed struct(u32) {
...
pub const HRTIM_TIMD_BASE_ADDRESS: usize = 0x40017600;
pub const HRTIM_TIMD_REGISTERS: *volatile HRTIM_TIMD = @ptrFromInt(HRTIM_TIMD_BASE_ADDRESS);
